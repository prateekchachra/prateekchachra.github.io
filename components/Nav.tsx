...
const Nav = () => {
  ...
  return (
   ...
   z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen bg-red-500/10"
    >
      <div
        className="flex w-full xl:flex-col items-center justify-between xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-[80px]
    xl:h-max py-8 bg-white/10 backdrop-blur-sm text-3xl xl:text-xl xl:rounded-full"
      >
        ...
        transition-all duration-300`}
            ...
            >
              {/* Tooltip */}
              <div className="absolute pr-14 right-0 hidden xl:group-hover:flex hover:transition-all duration-400">
                <div
