...
const Socials = () => {
  return <div className='flex items-center gap-x-5 text-lg'>
    ...
    <Link target="_blank" href='https://www.instagram.com/prattchach/' className='hover:text-accent transition-all duration-300'>
      <RiInstagramLine />
    </Link>
    <Link target="_blank" href='https://www.linkedin.com/in/prateek-chachra-3a2030a7/' className='hover:text-accent transition-all duration-300'>
      <RiLinkedinLine />
    </Link>
