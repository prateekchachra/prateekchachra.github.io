        ...
        >
          ...
          <div className="py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start">
            {aboutData[index].info.map((item, itemIndex) => (
              <div
                key={itemIndex}
                className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center justify-between text-white"
              >
                <div className="font-light mb-2 md:mb-0 max-w-[260px]">
                  {item.title}
                </div>
                ...
                {item.icons?.map((icon, ind) => (
                  <div
                    key={ind}
                    className="text-2xl transition-all relative group duration-500"
                  >
